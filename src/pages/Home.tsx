    ...
    <>
      ...
      <section className="pt-16 md:pt-24">
        <div className="mb-10 flex items-end justify-between px-6 md:mb-14 md:px-10">
          <div>
            <span className="label-wide text-mute">— Selected work</span>
          ...
          <Link
            to="/portfolio"
            className="group hidden items-center gap-3 border-b hairline-strong pb-1.5 label hover:border-cream transition-colors md:inline-flex"
          >
            View all
        ...
        <div className="mt-10 px-6 md:hidden">
          <Link
            to="/portfolio"
            className="group inline-flex items-center gap-3 border-b hairline-strong pb-1.5 label hover:border-cream transition-colors"
          >
            View all work
            <span className="inline-block transition-transform duration-500 ease-editorial group-hover:translate-x-2">
              →
      ...
      <section className="px-6 py-24 md:px-10 md:py-36">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-12 md:gap-16">
          <ScrollReveal className="md:col-span-4">
            <span className="label-wide text-mute">— About</span>
          </ScrollReveal>
  ...
  return (
    <div className="overflow-hidden border-y hairline py-6">
      <div className="flex gap-12 whitespace-nowrap animate-[marquee_40s_linear_infinite]">
        {reel.map((t, i) => (
          <span key={i} className="display-italic text-3xl md:text-4xl text-cream/80">
            {t}
          </span>
        ))}
      </div>

    ...
    <article className="pt-32 md:pt-40">
      <header className="px-6 pb-20 md:px-10 md:pb-28">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-12">
          <ScrollReveal className="md:col-span-12">
            <span className="label-wide text-mute">— Contact</span>
      ...
      <section className="grid grid-cols-1 gap-12 px-6 md:grid-cols-12 md:gap-16 md:px-10">
        ...
        <ScrollReveal className="md:col-span-4 md:pt-3">
          <p className="editorial text-lg text-cream/75 md:text-xl">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do
            eiusmod tempor incididunt.
          </p>
          <div className="mt-10 space-y-6 border-t hairline pt-8">
            <div>
              <span className="label-wide text-mute">Studio</span>
              <p className="display-italic mt-1.5 text-2xl">By appointment</p>
            </div>
            <div>
              <span className="label-wide text-mute">Email</span>
              <p className="mt-1.5">
                <a
                  href="mailto:hello@kristenandron.com"
                  className="border-b hairline-strong hover:border-cream transition-colors"
                >
            ...
            <div>
              <span className="label-wide text-mute">Elsewhere</span>
          ...
          <form onSubmit={onSubmit} className="grid grid-cols-1 gap-10">
                  ...
                  <button
                    ...
                    className={[
                      ...
                      inquiry === t
                        ...
                        : 'hairline-strong text-cream/70 hover:border-cream hover:text-cream',
                    ].join(' ')}
                  >
                    {t}
                  </button>
            ...
            <div className="pt-4">
              <button
                type="submit"
                data-cursor="hover"
                className="reset-btn group inline-flex items-center gap-3 border-b hairline-strong pb-2 label hover:border-cream transition-colors"
              >
                Send inquiry
...
function Field({
  ...
  return (
    <div>
      <label
        htmlFor={id}
        className="label-wide text-mute mb-3 block"
      >
        {label}
      </label>
      {children}
